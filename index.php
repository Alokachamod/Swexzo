      ...
      <nav class="navbar navbar-expand-lg col-10 offset-1 header">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">
            <img src="resources/Swexzo company logo.png" alt="icon" height="60px">
          </a>
          ...
          <div class="collapse navbar-collapse " id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 offset-xxl-4 ">
              <li class="nav-item ">
                <a class="nav-link position-relative g-6 m-3" aria-current="page" href="#sxhome">
                  <p class="htext">Home</p>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link position-relative g-6 m-3" href="#">
